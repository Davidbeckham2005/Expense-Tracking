...
import type { RegisterInput } from '../Schemas/auth.schema'; 1
        ...
        <div className="flex min-h-screen items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
            ...
            >
                ...
                <div className="text-center mb-6">
                    ...
                    <h2 className="text-3xl font-black tracking-tight text-white mb-2">Đăng Ký</h2>
                    <p className="text-slate-400 text-sm">Bắt đầu hành trình tích lũy thông minh</p>
                </div>
                ...
                <p className="text-center mt-6 text-sm text-slate-400">
                    Đã có tài khoản?{" "}
                    <Link to="/Login" className="text-theme hover:text-theme-300 font-semibold transition-colors">
                        Đăng nhập
                    </Link>
                </p>
            </form>
