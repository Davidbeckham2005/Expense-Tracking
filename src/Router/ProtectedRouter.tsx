    ...
    if (isLoading) {
        return (
            <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 text-white relative overflow-hidden">
                ...
                <div className="flex flex-col items-center bg-white/[0.02] backdrop-blur-md border border-white/[0.05] px-10 py-8 rounded-3xl shadow-2xl z-10 max-w-xs w-full text-center">
